...
using ECS.Common.Communicator.Module.Services;
using ECS.Common.Communicator.Interface.Services;

namespace QQApp
{
	public partial class QQProxy : ServiceProxyBase
    {

		readonly INetworkConnectionManager communicator;
