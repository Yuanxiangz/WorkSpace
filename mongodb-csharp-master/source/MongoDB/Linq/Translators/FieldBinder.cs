...
using MongoExpressionVisitor = MongoDB.Linq.Expressions.ExpressionVisitor;
using MongoDB.Util;

namespace MongoDB.Linq.Translators
{
    internal class FieldBinder : MongoExpressionVisitor
    {
        ...
        private class FieldFinder : MongoExpressionVisitor
        {
